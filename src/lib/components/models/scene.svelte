...
Command: npx @threlte/gltf@2.0.3 D:\30-day\static\models\scene.glb --root /models/ --types --printwidth 120 --precision 2
-->
...
<script lang="ts">
  ...
  export let shouldStop = false
    ...
    $:{
      ...
      console.log($actions['1st'] , $actions['2nd'] , $actions['3rd'])
