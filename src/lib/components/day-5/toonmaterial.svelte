<script lang="ts">
	...
	import { Vector3, LineBasicMaterial, type Vector3Tuple, CatmullRomCurve3 } from 'three';
...
<T.Mesh position={[0, 1, 0]} scale={2} rotation.x={Math.PI / 2}>
	<T.TorusGeometry args={[0.5, 0.2, 16, 100]} />
	<T.MeshToonMaterial color="purple" />
</T.Mesh>
